...
class Data_tingkat_sekolah_model extends CI_Model
{
    public $data_uri = 'data_tingkat_sekolah';
    public $table = 'tbl_tingkat_sekolah';
    public $id = 'id_tingkat';
    public $order = 'DESC';
    ...
    function json()
    {
        $this->datatables->select($this->id . ',nama_tingkat');
