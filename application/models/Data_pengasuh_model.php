...
class Data_pengasuh_model extends CI_Model
{
    public $data_uri = 'data_pengasuh';
    public $table = 'tbl_pengasuh';
    public $id = 'id_pengasuh';
    public $order = 'DESC';
    ...
    function json()
    {
        $this->datatables->select($this->id . ',nama_pengasuh');
        $this->datatables->from($this->table);
        //add this line for join
        // $this->datatables->join('tbl_pengasuh', $this->table . '.id_pengasuh = tbl_pengasuh.id_kepala');
    ...
    function total_rows($q = NULL)
    {
        ...
        $this->db->or_like('nama_pengasuh', $q);
