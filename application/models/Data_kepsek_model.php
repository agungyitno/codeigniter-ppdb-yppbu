...
class Data_kepsek_model extends CI_Model
{
    public $data_uri = 'data_kepsek';
    public $table = 'tbl_kepala_sekolah';
    public $id = 'id_kepsek';
    public $order = 'DESC';
    ...
    function json()
    {
        $this->datatables->select($this->id . ',nama_kepsek');
        $this->datatables->from($this->table);
        //add this line for join
        // $this->datatables->join('tbl_kepala_sekolah', $this->table . '.id_kepsek = tbl_kepala_sekolah.id_kepala');
