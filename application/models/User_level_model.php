...
class User_level_model extends CI_Model
{
    ...
    function json()
    {
        $this->datatables->select('id_user_level,nama_user_level');
        ...
        $this->datatables->add_column('action', anchor(site_url('userlevel/akses/$1'), '<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm')) . " 
            " . anchor(site_url('userlevel/update/$1'), '<i class="fas fa-pencil-alt" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm')) . " 
                " . anchor(site_url('userlevel/delete/$1'), '<i class="fa fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_user_level');
    ...
    function total_rows($q = NULL)
    {
        ...
        $this->db->or_like('nama_user_level', $q);
