...
class Data_pekerjaan_model extends CI_Model
{
    public $data_uri = 'data_pekerjaan';
    public $table = 'tbl_mst_pekerjaan';
    ...
    function json()
    {
        $this->datatables->select($this->id . ',nama_pekerjaan');
        $this->datatables->from($this->table);
        //add this line for join
        // $this->datatables->join('tbl_mst_pekerjaan', $this->table . '.id_pekerjaan = tbl_mst_pekerjaan.id_kepala');
