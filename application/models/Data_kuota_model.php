...
class Data_kuota_model extends CI_Model
{
    public $data_uri = 'data_kuota';
    public $table = 'tbl_kuota';
    public $id = 'id_kuota';
    public $order = 'DESC';
    ...
    function json()
    {
        $this->datatables->select($this->id . ',nama_sekolah,kuota');
