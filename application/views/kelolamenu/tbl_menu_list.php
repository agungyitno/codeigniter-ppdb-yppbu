        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h3 class="m-0 font-weight-bold text-primary">KELOLA DATA TBL_MENU</h3>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td></td>
                            <td><button type="submit" class="btn btn-danger btn-sm">Simpan Perubahan</button></td>
                        </tr>
                    </table>
                    </form>
                </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div style="padding-bottom: 10px;"'>
                        <?php echo anchor(site_url('kelolamenu/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger mb-2"'); ?>
                        <?php //echo anchor(site_url('kelolamenu/excel'), '<i class="fa fa-file-excel" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success "'); 
                        ?>
                        <?php //echo anchor(site_url('kelolamenu/word'), '<i class="fa fa-file-word" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary "'); 
                        ?>
                    </div>
