...
class Userlevel extends CI_Controller
{
    ...
    public function read($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_level' => $row->nama_user_level,
            );
    ...
    function kasi_akses_ajax()
    {
        ...
        // chek data
        $params = array('id_user_level' => $id_user_level, 'id_menu' => $id_menu);
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'nama_user_level' => $this->input->post('nama_level', TRUE),
            );
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_level' => set_value('nama_level', $row->nama_user_level),
            );
            $this->template->load('template', 'userlevel/tbl_user_level_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
