...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/read/\$1'),'<i class=\"fa fa-eye\" aria-hidden=\"true\"></i>', array('class' => 'btn btn-danger ')).\" 
            \".anchor(site_url('".$c_url."/update/\$1'),'<i class=\"fas fa-satellite-dish\" aria-hidden=\"true\"></i>', array('class' => 'btn btn-danger ')).\" 
                \".anchor(site_url('".$c_url."/delete/\$1'),'<i class=\"fa fa-trash\" aria-hidden=\"true\"></i>','class=\"btn btn-danger \" onclick=\"javasciprt: return confirm(\\'Are You Sure ?\\')\"'), '$pk');
